...
model_path = "./tuberculosisClassifier.h5"
...
def main():
    st.title("Tuberculosis Image Diagnostic (Normal/Tuberculosis)")
    result = ""
    img_file = st.file_uploader("Please Upload Patient's Chest X-Ray Image", type=["png"])
        ...
        if st.button("See Results"):
            ...
            if pred is not None:
                if pred > 0.5:
                    ...
                    result = "Patient has NO TUBERCULOSIS (NORMAL)!"
